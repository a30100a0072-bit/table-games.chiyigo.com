        ...
        >
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              onClick={handlePlay}
              className="tap44 min-w-[120px] rounded-xl bg-red-600 px-5 py-2.5 text-base font-bold text-white shadow transition hover:brightness-110 active:translate-y-[1px] disabled:cursor-not-allowed disabled:bg-gray-700 disabled:text-gray-500 disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={!isMyTurn}
              onClick={handlePass}
              className="tap44 min-w-[110px] rounded-xl bg-gray-600 px-5 py-2.5 text-base font-bold text-white shadow transition hover:brightness-110 active:translate-y-[1px] disabled:cursor-not-allowed disabled:bg-gray-700 disabled:text-gray-500 disabled:opacity-50"
            >
              {t("bt.pass")}
            </button>
          </div>
